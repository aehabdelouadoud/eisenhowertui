...
hidden if the `eisenhowertui_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `eisenhowertui_DEVELOPER_MODE` to the configure
...
Runs the executable target `eisenhowertui_exe`.
